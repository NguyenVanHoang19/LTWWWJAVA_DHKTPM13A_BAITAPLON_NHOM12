                                                ...
                                                <div id="demo" class="carousel slide" data-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner">
                                                        <div class="carousel-item active">
                                                            <img src="./resources/img/slider_1.jpg" alt="Los Angeles" width="1100" height="600">
                                                        </div>
                                                        <div class="carousel-item">
                                                            <img src="./resources/img/slider_2.jpg" alt="Chicago" width="1100" height="600">
                                                        </div>
                                                        <div class="./resources/img/slider_1.jpg">
                                                            <img src="./resources/img/slider_1.jpg" alt="New York" width="1100" height="600">
                                                        </div>
                                                    </div>
                    ...
                    <c:forEach items="${listDanhMuc }" var="dm">
                    	...
                    	<c:forEach items="${listSanPham }" var="sp">
	                        ...
	                        <form action="MuaHang" method="POST">
	                            ...
	                            <p>
	                            	<a href="<c:url value="/xemthongtinsanpham?maSanPham=${sp.maSanPham}"/>"><input type="button" class="btn btn-primary" value="Xem hàng" /></a>
