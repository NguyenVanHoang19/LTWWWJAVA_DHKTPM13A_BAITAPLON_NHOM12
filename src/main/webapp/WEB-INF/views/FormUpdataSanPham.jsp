			...
			<div class="col-sm-12">
				...
				<!-- Mã sản phẩm -->
					<div class="form-group">
						...
						<input class="form-control"  type="text" name="txtmasua" required="required" value="${suasp.maSanPham }" readonly>
					</div>
					
					<!-- Tên sản phẩm -->
					<div class="form-group">
						<label for="txtname">Tên sản phẩm</label> 
						<input class="form-control"  type="text" name="txttensua" required="required" value="${suasp.tenSanPham }">
					</div>
					
					<!-- Mô tả sản phẩm -->
					<div class="form-group">
						<label for="txtname">Mô tả sản phẩm</label> 
						<input class="form-control"  type="text" name="txtmotasua" required="required" value="${suasp.moTa }">
					</div>
					<!-- Đơn vị tính sản phẩm -->
					<div class="form-group">
						<label for="txtname">Đơn vị tính sản phẩm</label> 
						<input class="form-control"  type="text" name="txtdvtsua" required="required" value="${suasp.donViTinh }">
					</div>

					<!-- Số lượng sản phẩm -->
					<div class="form-group">
						<label for="txtquantity">Số lượng sản phẩm</label> 
						<input class="form-control" type="number"  name="txtslsua" required="required" value="${suasp.soLuongNhap }">
					</div>
					<!-- Giá sản phẩm -->
					<div class="form-group">
					...
					<div class="form-group">
						<label for="txtngay">Ngay sản phẩm</label> <input
							class="form-control" type="date" name="txtngaysua"  required="required" value="${suasp.ngaySanXuat }">
					</div>

					<!-- Loại sản phẩm -->
					<div class="form-group">
						<label>Nhà sản xuất</label> 
							<select name="txtNhaCungCapsua">
